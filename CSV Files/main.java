...
public class main {
		...
		do {
			...
			switch (choice) {
				...
				case 3: // Update Hospital Staff
					...
					System.out.print("Select new Role (1-DOCTOR, 2-PHARMACIST, 3-ADMINISTRATOR): ");
					...
					System.out.print("Select new Gender (1-MALE, 2-FEMALE, 3-OTHER): ");
					int genderChoice = scanner.nextInt();
					scanner.nextLine();
					Gender newGender = switch (genderChoice) {
						case 1 -> Gender.MALE;
					...
					admin.updateStaff(staffID, newName, newRole, newGender);
					break;
				...
				case 5: // View Appointments Details
					...
					if (appointmentOutcomes.isEmpty()) {
						...
						for (AppointmentOutcome outcome : appointmentOutcomes) {
							outcome.printAppointmentDetails();
						}
					}
					break;
	...
	private static void addNewStaff() {
		...
		newStaff.addStaff(hospitalID, password, role, gender, name);
	}
